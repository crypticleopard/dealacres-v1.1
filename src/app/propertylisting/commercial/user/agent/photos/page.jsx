        ...
        <DndProvider backend={HTML5Backend}>
            <section className='mt-12 container mx-auto lg:w-4/5'>
                ...
                <div className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-[2rem] container mx-auto my-10 overflow-auto'>
                    ...
                    <div className='h-full md:w-[350px] xl:w-[400px] md:mt-8 rounded-xl p-5 border-2 border-[#dcf0fd] shadow-md'>
                        ...
                        <p className='text-sm mb-3 mt-1'>At least add 5 images of your property for good visibility and high response.</p>
                        <Link href={'pricing'}>
                            <button
