      ...
      <section className='mt-12 container mx-auto lg:w-4/5'>
        ...
        <div className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-[2rem] container mx-auto my-10'>
          <div className='h-full lg:w-[420px] rounded-xl p-5 border-2 border-blue-200 shadow-md '>
            ...
            <h1 className="font-medium md:font-bold text-xl mb-3">Add Amenities and Features</h1>
            <AmenitiesList />
        ...
        <div className="md:px-24">
          ...
          <button
            ...
            className={`w-full bg-blue-600 rounded-xl px-8 py-3 font-bold text-white mt-5 mb-10  hover:bg-white hover:border-2 hover:border-blue-600 hover:text-blue-600 ${!isGDPRChecked || uploadedFiles.length === 0 ? 'cursor-not-allowed opacity-50'  : ''
              }`}
