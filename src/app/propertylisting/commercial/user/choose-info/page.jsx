...
const Info = () => {
    ...
    return (
        <section className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-20 container mx-auto my-10 overflow-auto'>
            ...
            <div className='h-full md:w-[450px] md:mt-16 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
                <h1 className="font-medium md:font-bold md:text-2xl text-xl mt-8">
                ...
                <Link href={getDynamicLink()}>
                    <button className='w-full bg-blue-600 rounded-xl px-8 py-3 font-bold text-white mb-8 hover:bg-white hover:text-blue-600 hover:border hover:border-blue-600'>Continue</button>
                </Link>
            </div>
