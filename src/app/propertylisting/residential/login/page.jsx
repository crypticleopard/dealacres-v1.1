...
const Login = () => {
    ...
    return (
        <section className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-20 mx-auto my-8 overflow-auto'>
            ...
            <div className='h-full md:w-[400px] md:mt-20 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
                ...
                <p className='text-sm text-blue-400 mt-1 pb-8'>Resend OTP</p>
