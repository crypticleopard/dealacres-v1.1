    ...
    <section className='mt-12 container mx-auto lg:w-4/5'>
      ...
      <div className="md:px-24">
        ...
        <button
          ...
          className={`w-full bg-blue-600 rounded-xl px-8 py-3 font-bold text-white mt-5 mb-10  hover:bg-white hover:border-2 hover:border-blue-600 hover:text-blue-600 ${!isGDPRChecked || uploadedFiles.length === 0 || expectedPrice.trim() === '' || pricePerSqYd.trim() === '' ? 'cursor-not-allowed bg-blue-400' : ''
            }`}
