...
const Page = () => {
  ...
  return (
    <section className='mt-12 container mx-auto lg:w-4/5'>
      ...
      <div className='flex flex-col md:flex-row px-4 items-start justify-center gap-10 md:gap-16 container mx-auto my-10 overflow-auto'>
        ...
        <div className='h-full w-[400px] rounded-xl bg-[#c9e2f3] p-4 flex flex-col items-center'>
          ...
          <Image src={'/propertyListing/assets/location.png'} alt='location' height={150} width={150} className='my-10' />
          <h1 className='font-bold text-xl'>Need Help?</h1>
          <p className='text-lg'>You Can Email Us</p>
          <p className='text-lg text-blue-600 mb-10'>Contact@dealacres.com</p>
        </div>
        <div className='h-full md:w-[400px] md:mt-16 rounded-xl p-5 border-t-4 border-r-2 border-l-2 border-[#dcf0fd] border-b-4'>
          ...
          {['state', 'city', 'projectName', 'area', 'houseNo'].map((fieldName) => (
            <input
              ...
              type='text'
              className='py-2 px-2 rounded-lg w-full mb-2 border-t-4 border-r-2 border-l-2 border-[#c7deee] border-b-4'
